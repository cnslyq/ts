...
print(str(datetime.datetime.today()) + " trade_index_today start...")
df = ts.get_index()
df = df.set_index('code', drop='true')
df['date'] = today
df.to_sql('trade_index_today', engine, if_exists='append')
print
print(str(datetime.datetime.today()) + " trade_index_today done")

print(str(datetime.datetime.today()) + " trade_market_today start...")
df = ts.get_today_all()
df = df.set_index('code', drop='true')
df['date'] = today
df.to_sql('trade_market_today', engine, if_exists='append')
print
print(str(datetime.datetime.today()) + " trade_market_today done")

print(str(datetime.datetime.today()) + " trade_block start...")
...
print
print(str(datetime.datetime.today()) + " trade_block done")
